...
<head>
  ...
  <title>{{$title}} @if($sub_menu)|| {{$sub_menu}} @endif - Aplikasi Pengaduan Masyarakat</title>
  <meta content='width=device-width, initial-scale=1.0, shrink-to-fit=no' name='viewport' />
  <link rel="icon" href="{{asset('/img/rsdgj.jpeg')}}" type="image/x-icon"/>
  ...
  <div class="wrapper">
    <div class="main-header">
      <!-- Logo Header -->
        ...
        <a href="#" class="logo">
          <b class="text-white">Pengaduan</b>
        </a>
            ...
            <li class="nav-item dropdown hidden-caret">
              ...
              <ul class="dropdown-menu dropdown-user animated fadeIn">
                <div class="dropdown-user-scroll scrollbar-outer">
                  ...
                  <a class="dropdown-item" href="{{url('user')}}">My Profile</a><div class="form-group">
                      <div class="dropdown-divider"></div>
      ...
      <footer class="footer">
        <div class="container-fluid">
          ...
          <div class="copyright ml-auto">
            2020, made with <i class="fa fa-heart heart text-danger"></i> by <a href="">UCIC</a>
          </div>
        </div>
      </footer>
    </div>
